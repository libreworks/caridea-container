 ...
 */
class AbstractContainerTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertEquals($this->instance, $this->object->named('myQueue', \SplQueue::class));
        $this->assertEquals('foobar', $this->object->named('config.var', 'string'));
    }
